...
//    AbstractMapProvider provider = new Google.GoogleTerrainProvider();
    ...
    //Create new UnfoldingMap with coordinates x = 410, y = 50, width = 350, height = 500
    map2 = new UnfoldingMap(this, 410, 50, 350, 500, provider);
    //Zoom on Saint-Petersburg
    map2.zoomAndPanTo(zoomLevel, new Location(59.93863, 30.31413));
  ...
  //Draw two squares(white and grey) in top left corner, one above another, vertically.
  ...
  //If mouse is inside white button -> background color changes to white,
  // inside the grey one -> to grey color.
  @Override
